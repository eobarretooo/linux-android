...
STRINGS[optional_pkg_failed]="⚠️  Pacote opcional indisponível ou falhou: %s"
...
# ===== Dispositivo =====
STRINGS[architecture]="🏗️  Arquitetura: %s"
STRINGS[device_info]="📱 Dispositivo: %s %s"
STRINGS[wine_arm64_warning]="⚠️  Wine/Hangover e aceleração gráfica costumam funcionar melhor em ARM64/aarch64."
...
STRINGS[gpu_adreno_not_detected]="⚠️  GPU Adreno não detectada. Usarei modo compatível sem aceleração forçada."
STRINGS[gpu_forced_warning]="⚠️  Aceleração GPU foi forçada. Se a tela ficar preta/travar, rode novamente e escolha a opção 3."
...
STRINGS[gpu_base_failed]="⚠️  Drivers mesa-zink/vulkan-loader-android falharam. Vou continuar em modo software."
STRINGS[gpu_software_mode]="💻 Modo software selecionado. Drivers GPU extras não serão forçados."

# ===== Desktop =====
STRINGS[desktop_title]="🖥️  Escolha o Desktop"
...
STRINGS[desktop_current]="🖥️  Desktop atual: %s"
...
STRINGS[desktop_remove_confirm]="⚠️  Tem certeza que deseja remover %s? [s/N]: "
STRINGS[desktop_removed]="🗑️  Desktop %s removido."
...
STRINGS[wine_not_arm64]="⚠️  Seu aparelho não parece ser ARM64/aarch64. Wine/Hangover pode não funcionar bem."
STRINGS[wine_shortcut_created]="✅ Atalho 'wine' criado."
STRINGS[wine_not_complete]="⚠️  Hangover Wine não parece ter sido instalado completamente."
STRINGS[wine_skipped]="⏭️  Wine/Hangover ignorado."
STRINGS[wine_install]="Instalar Wine/Hangover"
STRINGS[wine_remove]="Remover Wine/Hangover"
STRINGS[wine_status]="Status do Wine"
STRINGS[wine_remove_confirm]="⚠️  Tem certeza que deseja remover Wine/Hangover? [s/N]: "
STRINGS[wine_removed]="🗑️  Wine/Hangover removido."
...
STRINGS[themes_select_icons]="🖼️  Selecione os ícones: "
...
STRINGS[maint_components_missing]="⚠️  %s componente(s) ausente(s). Use o menu para reinstalar."
...
STRINGS[step_graphics_server]="🖥️  Instalando servidor gráfico"
STRINGS[step_installing_desktop]="🖥️  Instalando %s"
...
STRINGS[install_desktop_label]="🖥️  Desktop"
STRINGS[install_gpu_label]="🎮 GPU"
STRINGS[install_start_cmd]="▶️  Iniciar"
STRINGS[install_stop_cmd]="⏹️  Parar"
STRINGS[install_info_cmd]="ℹ️  Info"
STRINGS[install_log_label]="📄 Log"
STRINGS[install_open_x11]="📱 Depois de iniciar, abra o app Termux-X11 para ver a interface."
STRINGS[install_start_now]="▶️  Deseja iniciar o desktop agora? [s/N]: "
