...
STRINGS[optional_pkg_failed]="⚠️  Optional package unavailable or failed: %s"
...
# ===== Device =====
STRINGS[architecture]="🏗️  Architecture: %s"
STRINGS[device_info]="📱 Device: %s %s"
STRINGS[wine_arm64_warning]="⚠️  Wine/Hangover and GPU acceleration work best on ARM64/aarch64."
...
STRINGS[gpu_adreno_not_detected]="⚠️  Adreno GPU not detected. Using compatible mode without forced acceleration."
STRINGS[gpu_forced_warning]="⚠️  GPU acceleration was forced. If the screen goes black/freezes, run again and choose option 3."
...
STRINGS[gpu_base_failed]="⚠️  mesa-zink/vulkan-loader-android drivers failed. Continuing in software mode."
STRINGS[gpu_software_mode]="💻 Software mode selected. Extra GPU drivers will not be forced."

# ===== Desktop =====
STRINGS[desktop_title]="🖥️  Choose Desktop"
...
STRINGS[desktop_current]="🖥️  Current desktop: %s"
...
STRINGS[desktop_remove_confirm]="⚠️  Are you sure you want to remove %s? [y/N]: "
STRINGS[desktop_removed]="🗑️  Desktop %s removed."
...
STRINGS[wine_not_arm64]="⚠️  Your device doesn't appear to be ARM64/aarch64. Wine/Hangover may not work well."
STRINGS[wine_shortcut_created]="✅ Wine shortcut created."
STRINGS[wine_not_complete]="⚠️  Hangover Wine doesn't appear to be fully installed."
STRINGS[wine_skipped]="⏭️  Wine/Hangover skipped."
STRINGS[wine_install]="Install Wine/Hangover"
STRINGS[wine_remove]="Remove Wine/Hangover"
STRINGS[wine_status]="Wine status"
STRINGS[wine_remove_confirm]="⚠️  Are you sure you want to remove Wine/Hangover? [y/N]: "
STRINGS[wine_removed]="🗑️  Wine/Hangover removed."
...
STRINGS[themes_select_icons]="🖼️  Select icons: "
...
STRINGS[maint_components_missing]="⚠️  %s component(s) missing. Use the menu to reinstall."
...
STRINGS[step_graphics_server]="🖥️  Installing graphics server"
STRINGS[step_installing_desktop]="🖥️  Installing %s"
...
STRINGS[install_start_cmd]="▶️  Start"
STRINGS[install_stop_cmd]="⏹️  Stop"
...
STRINGS[install_start_now]="▶️  Start the desktop now? [y/N]: "
